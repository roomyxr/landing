  ...
  return (
    <footer className="pt-32 pb-16 bg-primary">
      <div className="mx-auto max-w-screen-2xl z-10 px-6 lg:px-8 border-t border-white/80 pt-10">
        ...
        {/* Главна содржина во футерот */}
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5 transform-gpu">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <svg className="w-5 h-5 text-white/80 group-hover:text-[#5865F2] transition-colors duration-300 transform-gpu" viewBox="0 0 24 24" fill="currentColor">
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 transition-all group"
                >
                  <svg className="w-5 h-5 text-white/80 group-hover:text-[#FF0000] transition-colors duration-300 transform-gpu" viewBox="0 0 24 24" fill="currentColor">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 transition-all group"
                >
                  <svg className="w-5 h-5 text-white/80 group-hover:text-[#00F2FE] transition-colors duration-300 transform-gpu" viewBox="0 0 24 24" fill="currentColor">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 transition-all group"
                >
                  <svg className="w-5 h-5 text-white/80 group-hover:text-[#0A66C2] transition-colors duration-300 transform-gpu" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Повик за Акција (CTA Button) */}
          <div className="flex flex-col items-start lg:items-end justify-start">
            <a
              href="#special-offer"
              className="rounded-full bg-white px-8 py-3 text-sm font-extrabold text-primary shadow-2xl hover:bg-gray-100 transition-all duration-300 transform-gpu hover:scale-110 uppercase tracking-widest"
            >
              BECOME FOUNDER
            </a>
        ...
        {/* Долен дел на футерот (Copyright + Мало Лого + Правни документи) */}
        <div className="mt-24 border-t border-white/80 pt-12 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-x-8 text-sm text-white/80 font-bold">
            <button 
              ...
              className="hover:text-white transition-colors duration-300 uppercase transform-gpu"
            >
              Privacy Policy
            </button>
            <button 
